...
keys = [
    ...
    Key([mod], "d", lazy.spawn(launcher), desc="Run program launcher"),
...
layouts = [
    layout.Columns(border_focus_stack=[color_theme[7], color_theme[3]], border_width=4),
    layout.Max(),
    ...
    Screen(
        top=bar.Bar(
            [
                ...
                widget.CheckUpdates(
                    distro="Arch_paru",
                    colour_have_updates=color_theme[2],
                    colour_no_updates=color_theme[2]
                ),
                widget.Sep(
                    foreground=color_theme[5],
                    linewidth=2,
